...
pub struct ListAccountAcquisitionRequest<'a> {
...
impl<'a> ListAccountAcquisitionRequest<'a> {
    pub async fn send(self) -> anyhow::Result<AccountAcquisitionList> {
        let mut r = self.http_client.client.get("/acquisitions");
