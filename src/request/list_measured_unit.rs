...
pub struct ListMeasuredUnitRequest<'a> {
...
impl<'a> ListMeasuredUnitRequest<'a> {
    pub async fn send(self) -> anyhow::Result<MeasuredUnitList> {
        let mut r = self.http_client.client.get("/measured_units");
