...
pub struct ListShippingMethodsRequest<'a> {
...
impl<'a> ListShippingMethodsRequest<'a> {
    pub async fn send(self) -> anyhow::Result<ShippingMethodList> {
        let mut r = self.http_client.client.get("/shipping_methods");
