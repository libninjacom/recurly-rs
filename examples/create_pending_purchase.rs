...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { tax_inclusive : Some(true), end_date :
                Some("your end date".to_owned()), currency : "your currency".to_owned(),
                unit_amount : 1.0, item_id : Some("your item id".to_owned()),
                accounting_code : Some("your accounting code".to_owned()), origin :
                Some("your origin".to_owned()), quantity : Some(1), type_ : "your type"
                .to_owned(), tax_exempt : Some(true), description :
                Some("your description".to_owned()), credit_reason_code :
                Some("your credit reason code".to_owned()), product_code :
                Some("your product code".to_owned()), revenue_schedule_type :
                Some("your revenue schedule type".to_owned()), avalara_service_type :
                Some(1), tax_code : Some("your tax code".to_owned()), start_date :
                Some("your start date".to_owned()), item_code : Some("your item code"
                .to_owned()), avalara_transaction_type : Some(1) }
            ],
        )
        .subscriptions(
            vec![
                SubscriptionPurchase { unit_amount : Some(1.0), add_ons :
                ...
                starts_at : Some("your starts at".to_owned()), custom_fields :
                Some(CustomFields(vec![CustomField { name : "your name".to_owned(), value
                : "your value".to_owned() }])), plan_code : "your plan code".to_owned(),
                tax_inclusive : Some(true), next_bill_date : Some("your next bill date"
                .to_owned()), renewal_billing_cycles : Some(1), total_billing_cycles :
                Some(1), revenue_schedule_type : Some("your revenue schedule type"
                .to_owned()), auto_renew : Some(true), ramp_intervals :
                Some(vec![SubscriptionRampInterval { unit_amount : Some(1),
                starting_billing_cycle : Some(1) }]), trial_ends_at :
                Some("your trial ends at".to_owned()), shipping :
                ...
                Some(1.0) }), plan_id : Some("your plan id".to_owned()) }
            ],
        )
