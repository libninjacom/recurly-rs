...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { currency : "your currency".to_owned(), item_code :
                Some("your item code".to_owned()), avalara_transaction_type : Some(1),
                credit_reason_code : Some("your credit reason code".to_owned()),
                accounting_code : Some("your accounting code".to_owned()), tax_code :
                Some("your tax code".to_owned()), description : Some("your description"
                .to_owned()), tax_inclusive : Some(true), product_code :
                Some("your product code".to_owned()), unit_amount : 1.0, quantity :
                Some(1), revenue_schedule_type : Some("your revenue schedule type"
                .to_owned()), start_date : Some("your start date".to_owned()), type_ :
                "your type".to_owned(), tax_exempt : Some(true), avalara_service_type :
                Some(1), end_date : Some("your end date".to_owned()), item_id :
        ...
        .subscriptions(
            vec![
                ...
                Some(1), add_ons : Some(vec![SubscriptionAddOnCreate {
                unit_amount_decimal : Some("your unit amount decimal".to_owned()),
                unit_amount : Some(1.0), tiers : Some(vec![SubscriptionAddOnTier {
                unit_amount : Some(1.0), usage_percentage : Some("your usage percentage"
                .to_owned()), ending_quantity : Some(1), unit_amount_decimal :
                ...
                "your code".to_owned() }]), total_billing_cycles : Some(1), custom_fields
                ...
                Some(1), starting_billing_cycle : Some(1) }]), auto_renew : Some(true),
                renewal_billing_cycles : Some(1), tax_inclusive : Some(true), plan_code :
                "your plan code".to_owned(), starts_at : Some("your starts at"
