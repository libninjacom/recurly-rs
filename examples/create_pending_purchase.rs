...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { item_code : Some("your item code".to_owned()),
                start_date : Some("your start date".to_owned()), quantity : Some(1),
                tax_exempt : Some(true), avalara_service_type : Some(1), tax_inclusive :
                Some(true), type_ : "your type".to_owned(), avalara_transaction_type :
                Some(1), currency : "your currency".to_owned(), unit_amount : 1.0,
                tax_code : Some("your tax code".to_owned()), item_id :
                ...
                .to_owned()), end_date : Some("your end date".to_owned()),
        ...
        .subscriptions(
            vec![
                SubscriptionPurchase { renewal_billing_cycles : Some(1),
                total_billing_cycles : Some(1), plan_id : Some("your plan id"
                ...
                Some(1), usage_percentage : Some(1.0), percentage_tiers :
                ...
                }]), tax_inclusive : Some(true), auto_renew : Some(true), shipping :
                ...
                Some(1.0) }), unit_amount : Some(1.0), quantity : Some(1),
                revenue_schedule_type : Some("your revenue schedule type".to_owned()),
                trial_ends_at : Some("your trial ends at".to_owned()), ramp_intervals :
