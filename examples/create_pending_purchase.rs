...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { avalara_service_type : Some(1), credit_reason_code :
                Some("your credit reason code".to_owned()), currency : "your currency"
                .to_owned(), unit_amount : 1.0, tax_inclusive : Some(true), end_date :
                Some("your end date".to_owned()), avalara_transaction_type : Some(1),
                accounting_code : Some("your accounting code".to_owned()), origin :
                Some("your origin".to_owned()), start_date : Some("your start date"
                .to_owned()), item_id : Some("your item id".to_owned()), quantity :
                Some(1), item_code : Some("your item code".to_owned()), type_ :
                "your type".to_owned(), tax_code : Some("your tax code".to_owned()),
                revenue_schedule_type : Some("your revenue schedule type".to_owned()),
                description : Some("your description".to_owned()), tax_exempt :
                Some(true), product_code : Some("your product code".to_owned()) }
            ],
        )
        .subscriptions(
            vec![
                SubscriptionPurchase { next_bill_date : Some("your next bill date"
                .to_owned()), quantity : Some(1), tax_inclusive : Some(true),
                revenue_schedule_type : Some("your revenue schedule type".to_owned()),
                ramp_intervals : Some(vec![SubscriptionRampInterval { unit_amount :
                Some(1), starting_billing_cycle : Some(1) }]), shipping :
                Some(SubscriptionShippingPurchase { method_code : Some("your method code"
                .to_owned()), method_id : Some("your method id".to_owned()), amount :
                Some(1.0) }), total_billing_cycles : Some(1), starts_at :
                Some("your starts at".to_owned()), plan_code : "your plan code"
                .to_owned(), add_ons : Some(vec![SubscriptionAddOnCreate { unit_amount :
                ...
                Some("your usage percentage".to_owned()) }]), usage_percentage :
                Some(1.0), unit_amount_decimal : Some("your unit amount decimal"
                .to_owned()), code : "your code".to_owned(), revenue_schedule_type :
                Some("your revenue schedule type".to_owned()) }]), trial_ends_at :
                Some("your trial ends at".to_owned()), plan_id : Some("your plan id"
                .to_owned()), unit_amount : Some(1.0), auto_renew : Some(true),
                renewal_billing_cycles : Some(1), custom_fields :
