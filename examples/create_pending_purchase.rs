...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { item_id : Some("your item id".to_owned()), start_date :
                Some("your start date".to_owned()), currency : "your currency"
                .to_owned(), end_date : Some("your end date".to_owned()), description :
                Some("your description".to_owned()), tax_inclusive : Some(true), origin :
                Some("your origin".to_owned()), type_ : "your type".to_owned(),
                ...
                unit_amount : 1.0, quantity : Some(1), tax_code : Some("your tax code"
                .to_owned()), credit_reason_code : Some("your credit reason code"
                .to_owned()), tax_exempt : Some(true), item_code : Some("your item code"
        ...
        .subscriptions(
            vec![
                ...
                add_ons : Some(vec![SubscriptionAddOnCreate { quantity : Some(1),
                ...
                unit_amount : Some(1.0) }]), usage_percentage : Some(1.0), unit_amount :
                ...
                Some(1.0) }), tax_inclusive : Some(true), ramp_intervals :
                Some(vec![SubscriptionRampInterval { starting_billing_cycle : Some(1),
                unit_amount : Some(1) }]), starts_at : Some("your starts at".to_owned()),
                plan_code : "your plan code".to_owned(), total_billing_cycles : Some(1),
                auto_renew : Some(true), trial_ends_at : Some("your trial ends at"
                .to_owned()), unit_amount : Some(1.0), next_bill_date :
                Some("your next bill date".to_owned()), plan_id : Some("your plan id"
                .to_owned()), quantity : Some(1), renewal_billing_cycles : Some(1) }
            ],
        )
