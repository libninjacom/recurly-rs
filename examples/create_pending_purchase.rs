...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { origin : Some("your origin".to_owned()), item_id :
                Some("your item id".to_owned()), item_code : Some("your item code"
                ...
                : Some("your tax code".to_owned()), tax_exempt : Some(true), currency :
                "your currency".to_owned(), tax_inclusive : Some(true), type_ :
                "your type".to_owned(), avalara_service_type : Some(1), start_date :
                Some("your start date".to_owned()), description : Some("your description"
                .to_owned()), product_code : Some("your product code".to_owned()),
                end_date : Some("your end date".to_owned()), unit_amount : 1.0, quantity
        ...
        .subscriptions(
            vec![
                SubscriptionPurchase { tax_inclusive : Some(true), trial_ends_at :
                Some("your trial ends at".to_owned()), next_bill_date :
                Some("your next bill date".to_owned()), plan_id : Some("your plan id"
                .to_owned()), quantity : Some(1), ramp_intervals :
                Some(vec![SubscriptionRampInterval { starting_billing_cycle : Some(1),
                unit_amount : Some(1) }]), unit_amount : Some(1.0), plan_code :
                "your plan code".to_owned(), add_ons : Some(vec![SubscriptionAddOnCreate
                ...
                code : "your code".to_owned(), revenue_schedule_type :
                ...
                : Some(1.0) }]) }]), shipping : Some(SubscriptionShippingPurchase {
                method_code : Some("your method code".to_owned()), amount : Some(1.0),
                method_id : Some("your method id".to_owned()) }), revenue_schedule_type :
