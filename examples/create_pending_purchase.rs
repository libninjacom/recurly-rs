...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { tax_exempt : Some(true), item_id : Some("your item id"
                .to_owned()), unit_amount : 1.0, origin : Some("your origin".to_owned()),
                tax_code : Some("your tax code".to_owned()), accounting_code :
                Some("your accounting code".to_owned()), description :
                Some("your description".to_owned()), revenue_schedule_type :
                ...
                Some("your end date".to_owned()), tax_inclusive : Some(true), quantity :
                Some(1), avalara_service_type : Some(1), type_ : "your type".to_owned(),
                item_code : Some("your item code".to_owned()), product_code :
                Some("your product code".to_owned()), avalara_transaction_type : Some(1),
                credit_reason_code : Some("your credit reason code".to_owned()) }
            ],
        )
        .subscriptions(
            vec![
                SubscriptionPurchase { starts_at : Some("your starts at".to_owned()),
                next_bill_date : Some("your next bill date".to_owned()), add_ons :
                Some(vec![SubscriptionAddOnCreate { quantity : Some(1), usage_percentage
                : Some(1.0), tiers : Some(vec![SubscriptionAddOnTier { ending_quantity :
                Some(1), unit_amount_decimal : Some("your unit amount decimal"
                ...
                add_on_source : Some("your add on source".to_owned()), code : "your code"
                .to_owned(), unit_amount : Some(1.0), revenue_schedule_type :
                Some("your revenue schedule type".to_owned()) }]), plan_code :
                "your plan code".to_owned(), renewal_billing_cycles : Some(1),
                ...
                Some(1), starting_billing_cycle : Some(1) }]), plan_id :
                Some("your plan id".to_owned()), quantity : Some(1), custom_fields :
                Some(CustomFields(vec![CustomField { value : "your value".to_owned(),
                name : "your name".to_owned() }])), unit_amount : Some(1.0),
                tax_inclusive : Some(true), shipping : Some(SubscriptionShippingPurchase
                { amount : Some(1.0), method_id : Some("your method id".to_owned()),
                method_code : Some("your method code".to_owned()) }),
                total_billing_cycles : Some(1), auto_renew : Some(true), trial_ends_at :
                Some("your trial ends at".to_owned()) }
            ],
        )
