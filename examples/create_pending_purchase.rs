    ...
    let response = client
        ...
        .subscriptions(
            vec![
                ...
                add_ons : Some(vec![SubscriptionAddOnCreate { tiers :
                ...
                }]), add_on_source : Some("your add on source".to_owned()),
                percentage_tiers : Some(vec![SubscriptionAddOnPercentageTier {
                usage_percentage : Some("your usage percentage".to_owned()),
                ending_amount : Some(1.0) }]), usage_percentage : Some(1.0), quantity :
                Some(1), revenue_schedule_type : Some("your revenue schedule type"
                .to_owned()), code : "your code".to_owned(), unit_amount_decimal :
                Some("your unit amount decimal".to_owned()), unit_amount : Some(1.0) }]),
                renewal_billing_cycles : Some(1), auto_renew : Some(true), quantity :
                Some(1), trial_ends_at : Some("your trial ends at".to_owned()),
                tax_inclusive : Some(true), plan_code : "your plan code".to_owned(),
                next_bill_date : Some("your next bill date".to_owned()),
                total_billing_cycles : Some(1), shipping :
                ...
                unit_amount : Some(1.0), custom_fields :
                Some(CustomFields(vec![CustomField { value : "your value".to_owned(),
                name : "your name".to_owned() }])), ramp_intervals :
