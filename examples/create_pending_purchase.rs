...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { end_date : Some("your end date".to_owned()), tax_code :
                Some("your tax code".to_owned()), currency : "your currency".to_owned(),
                tax_inclusive : Some(true), type_ : "your type".to_owned(),
                avalara_service_type : Some(1), origin : Some("your origin".to_owned()),
                item_id : Some("your item id".to_owned()), tax_exempt : Some(true),
                ...
                Some("your item code".to_owned()), unit_amount : 1.0,
                avalara_transaction_type : Some(1), description : Some("your description"
                .to_owned()), accounting_code : Some("your accounting code".to_owned()),
                product_code : Some("your product code".to_owned()), start_date :
                Some("your start date".to_owned()) }
            ],
        )
        .subscriptions(
            vec![
                SubscriptionPurchase { total_billing_cycles : Some(1),
