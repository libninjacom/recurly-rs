...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { type_ : "your type".to_owned(), product_code :
                Some("your product code".to_owned()), item_id : Some("your item id"
                .to_owned()), avalara_transaction_type : Some(1), start_date :
                Some("your start date".to_owned()), credit_reason_code :
                Some("your credit reason code".to_owned()), quantity : Some(1),
                unit_amount : 1.0, item_code : Some("your item code".to_owned()),
                tax_exempt : Some(true), end_date : Some("your end date".to_owned()),
                description : Some("your description".to_owned()), tax_inclusive :
                Some(true), currency : "your currency".to_owned(), avalara_service_type :
                Some(1), tax_code : Some("your tax code".to_owned()), origin :
                Some("your origin".to_owned()), revenue_schedule_type :
        ...
        .subscriptions(
            vec![
                ...
                .to_owned()), add_ons : Some(vec![SubscriptionAddOnCreate { add_on_source
                : Some("your add on source".to_owned()), unit_amount : Some(1.0),
                revenue_schedule_type : Some("your revenue schedule type".to_owned()),
                quantity : Some(1), usage_percentage : Some(1.0), unit_amount_decimal :
                ...
                unit_amount : Some(1), starting_billing_cycle : Some(1) }]), auto_renew :
                Some(true), plan_code : "your plan code".to_owned(),
                ...
                revenue_schedule_type : Some("your revenue schedule type".to_owned()),
                plan_id : Some("your plan id".to_owned()), custom_fields :
                Some(CustomFields(vec![CustomField { name : "your name".to_owned(), value
                : "your value".to_owned() }])), total_billing_cycles : Some(1),
                unit_amount : Some(1.0), tax_inclusive : Some(true), starts_at :
                Some("your starts at".to_owned()), quantity : Some(1) }
            ],
        )
