...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { type_ : "your type".to_owned(), credit_reason_code :
                Some("your credit reason code".to_owned()), accounting_code :
                Some("your accounting code".to_owned()), unit_amount : 1.0, tax_inclusive
                : Some(true), currency : "your currency".to_owned(), avalara_service_type
                : Some(1), tax_code : Some("your tax code".to_owned()), item_id :
                Some("your item id".to_owned()), start_date : Some("your start date"
                .to_owned()), product_code : Some("your product code".to_owned()), origin
                : Some("your origin".to_owned()), quantity : Some(1), description :
                Some("your description".to_owned()), item_code : Some("your item code"
                .to_owned()), tax_exempt : Some(true), revenue_schedule_type :
                Some("your revenue schedule type".to_owned()), avalara_transaction_type :
                Some(1), end_date : Some("your end date".to_owned()) }
            ],
        )
        .subscriptions(
            vec![
                SubscriptionPurchase { unit_amount : Some(1.0), plan_id :
                Some("your plan id".to_owned()), quantity : Some(1), shipping :
                ...
                tax_inclusive : Some(true), revenue_schedule_type :
                ...
                add_ons : Some(vec![SubscriptionAddOnCreate { code : "your code"
                ...
                Some("your add on source".to_owned()) }]), custom_fields :
                Some(CustomFields(vec![CustomField { name : "your name".to_owned(), value
                : "your value".to_owned() }])), total_billing_cycles : Some(1),
                renewal_billing_cycles : Some(1), auto_renew : Some(true), next_bill_date
