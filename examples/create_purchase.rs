...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { quantity : Some(1), tax_exempt : Some(true),
                avalara_service_type : Some(1), product_code : Some("your product code"
                .to_owned()), revenue_schedule_type : Some("your revenue schedule type"
                .to_owned()), currency : "your currency".to_owned(), tax_inclusive :
                Some(true), description : Some("your description".to_owned()),
                accounting_code : Some("your accounting code".to_owned()), origin :
                Some("your origin".to_owned()), credit_reason_code :
                Some("your credit reason code".to_owned()), unit_amount : 1.0,
                avalara_transaction_type : Some(1), tax_code : Some("your tax code"
                .to_owned()), end_date : Some("your end date".to_owned()), item_code :
                Some("your item code".to_owned()), type_ : "your type".to_owned(),
                start_date : Some("your start date".to_owned()), item_id :
        ...
        .subscriptions(
            vec![
                ...
                .to_owned()), shipping : Some(SubscriptionShippingPurchase { amount :
                Some(1.0), method_code : Some("your method code".to_owned()), method_id :
                Some("your method id".to_owned()) }), total_billing_cycles : Some(1),
                custom_fields : Some(CustomFields(vec![CustomField { name : "your name"
                .to_owned(), value : "your value".to_owned() }])), add_ons :
                Some(vec![SubscriptionAddOnCreate { code : "your code".to_owned(),
                unit_amount : Some(1.0), quantity : Some(1), unit_amount_decimal :
                ...
                .to_owned()) }]), plan_id : Some("your plan id".to_owned()), quantity :
                Some(1), starts_at : Some("your starts at".to_owned()), trial_ends_at :
                Some("your trial ends at".to_owned()), auto_renew : Some(true), plan_code
                : "your plan code".to_owned(), ramp_intervals :
                Some(vec![SubscriptionRampInterval { starting_billing_cycle : Some(1),
                unit_amount : Some(1) }]), renewal_billing_cycles : Some(1),
                tax_inclusive : Some(true), unit_amount : Some(1.0),
