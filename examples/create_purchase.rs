    ...
    let response = client
        ...
        .line_items(
            vec![
                ...
                Some(1), item_code : Some("your item code".to_owned()), currency :
                "your currency".to_owned(), item_id : Some("your item id".to_owned()),
                quantity : Some(1), origin : Some("your origin".to_owned()), unit_amount
                : 1.0, end_date : Some("your end date".to_owned()), tax_code :
                ...
                product_code : Some("your product code".to_owned()), avalara_service_type
                : Some(1), tax_exempt : Some(true), credit_reason_code :
        ...
        .subscriptions(
            vec![
                ...
                plan_code : "your plan code".to_owned(), plan_id : Some("your plan id"
                .to_owned()), unit_amount : Some(1.0), add_ons :
                Some(vec![SubscriptionAddOnCreate { tiers :
                ...
                Some(1.0), code : "your code".to_owned(), add_on_source :
                Some("your add on source".to_owned()), unit_amount : Some(1.0) }]),
                total_billing_cycles : Some(1), quantity : Some(1), auto_renew :
                Some(true), next_bill_date : Some("your next bill date".to_owned()),
                shipping : Some(SubscriptionShippingPurchase { amount : Some(1.0),
                method_id : Some("your method id".to_owned()), method_code :
                Some("your method code".to_owned()) }), custom_fields :
                Some(CustomFields(vec![CustomField { name : "your name".to_owned(), value
                : "your value".to_owned() }])), tax_inclusive : Some(true),
                ramp_intervals : Some(vec![SubscriptionRampInterval {
                starting_billing_cycle : Some(1), unit_amount : Some(1) }]),
                renewal_billing_cycles : Some(1), trial_ends_at :
