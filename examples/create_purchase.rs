...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { tax_exempt : Some(true), avalara_service_type : Some(1),
                currency : "your currency".to_owned(), tax_inclusive : Some(true), type_
                : "your type".to_owned(), avalara_transaction_type : Some(1), unit_amount
                : 1.0, credit_reason_code : Some("your credit reason code".to_owned()),
                quantity : Some(1), item_id : Some("your item id".to_owned()),
                product_code : Some("your product code".to_owned()), origin :
                Some("your origin".to_owned()), tax_code : Some("your tax code"
                ...
                Some("your description".to_owned()), item_code : Some("your item code"
                .to_owned()) }
            ],
        )
        .subscriptions(
            vec![
                SubscriptionPurchase { quantity : Some(1), auto_renew : Some(true),
                tax_inclusive : Some(true), starts_at : Some("your starts at"
                .to_owned()), plan_id : Some("your plan id".to_owned()),
                renewal_billing_cycles : Some(1), unit_amount : Some(1.0), add_ons :
                Some(vec![SubscriptionAddOnCreate { add_on_source :
                Some("your add on source".to_owned()), unit_amount : Some(1.0), quantity
                : Some(1), usage_percentage : Some(1.0), revenue_schedule_type :
                ...
                .to_owned()) }]), code : "your code".to_owned(), percentage_tiers :
