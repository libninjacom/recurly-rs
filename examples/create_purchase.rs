    ...
    let response = client
        ...
        .line_items(
            vec![
                ...
                Some("your revenue schedule type".to_owned()), currency : "your currency"
                .to_owned(), avalara_transaction_type : Some(1), credit_reason_code :
                Some("your credit reason code".to_owned()), quantity : Some(1),
                unit_amount : 1.0, description : Some("your description".to_owned()),
                avalara_service_type : Some(1), type_ : "your type".to_owned(),
                tax_exempt : Some(true), end_date : Some("your end date".to_owned()),
                tax_inclusive : Some(true), accounting_code : Some("your accounting code"
                .to_owned()), origin : Some("your origin".to_owned()), tax_code :
                Some("your tax code".to_owned()), start_date : Some("your start date"
                .to_owned()), item_code : Some("your item code".to_owned()), product_code
                : Some("your product code".to_owned()), item_id : Some("your item id"
                .to_owned()) }
            ],
        )
        .subscriptions(
            vec![
                ...
                .to_owned()), tax_inclusive : Some(true), add_ons :
                Some(vec![SubscriptionAddOnCreate { usage_percentage : Some(1.0), tiers :
                ...
                unit_amount : Some(1.0), revenue_schedule_type :
                Some("your revenue schedule type".to_owned()), code : "your code"
                .to_owned(), add_on_source : Some("your add on source".to_owned()),
                percentage_tiers : Some(vec![SubscriptionAddOnPercentageTier {
                usage_percentage : Some("your usage percentage".to_owned()),
                ending_amount : Some(1.0) }]) }]), plan_id : Some("your plan id"
                .to_owned()), total_billing_cycles : Some(1), shipping :
                Some(SubscriptionShippingPurchase { method_code : Some("your method code"
                .to_owned()), amount : Some(1.0), method_id : Some("your method id"
                .to_owned()) }), ramp_intervals : Some(vec![SubscriptionRampInterval {
                unit_amount : Some(1), starting_billing_cycle : Some(1) }]), unit_amount
                : Some(1.0), next_bill_date : Some("your next bill date".to_owned()),
                custom_fields : Some(CustomFields(vec![CustomField { value : "your value"
                .to_owned(), name : "your name".to_owned() }])), renewal_billing_cycles :
                Some(1), starts_at : Some("your starts at".to_owned()), quantity :
                Some(1), plan_code : "your plan code".to_owned(), revenue_schedule_type :
                Some("your revenue schedule type".to_owned()), auto_renew : Some(true) }
            ],
        )
