...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { tax_code : Some("your tax code".to_owned()), quantity :
                Some(1), currency : "your currency".to_owned(), description :
                Some("your description".to_owned()), origin : Some("your origin"
                .to_owned()), unit_amount : 1.0, credit_reason_code :
                Some("your credit reason code".to_owned()), start_date :
                Some("your start date".to_owned()), item_id : Some("your item id"
                .to_owned()), tax_exempt : Some(true), avalara_service_type : Some(1),
                type_ : "your type".to_owned(), avalara_transaction_type : Some(1),
                product_code : Some("your product code".to_owned()), tax_inclusive :
                ...
                item_code : Some("your item code".to_owned()), end_date :
                Some("your end date".to_owned()) }
            ],
        )
        .subscriptions(
            vec![
                ...
                .to_owned()), amount : Some(1.0) }), trial_ends_at :
                Some("your trial ends at".to_owned()), ramp_intervals :
                Some(vec![SubscriptionRampInterval { unit_amount : Some(1),
                starting_billing_cycle : Some(1) }]), starts_at : Some("your starts at"
                .to_owned()), add_ons : Some(vec![SubscriptionAddOnCreate { tiers :
                ...
                plan_code : "your plan code".to_owned(), next_bill_date :
                Some("your next bill date".to_owned()), tax_inclusive : Some(true),
                quantity : Some(1), plan_id : Some("your plan id".to_owned()), auto_renew
                : Some(true), renewal_billing_cycles : Some(1), total_billing_cycles :
                Some(1) }
            ],
        )
