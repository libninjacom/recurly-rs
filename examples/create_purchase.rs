...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { product_code : Some("your product code".to_owned()),
                ...
                tax_exempt : Some(true), avalara_transaction_type : Some(1), type_ :
                "your type".to_owned(), avalara_service_type : Some(1), tax_code :
                Some("your tax code".to_owned()), tax_inclusive : Some(true), unit_amount
                : 1.0, currency : "your currency".to_owned(), end_date :
                Some("your end date".to_owned()), description : Some("your description"
                .to_owned()), item_id : Some("your item id".to_owned()), accounting_code
                : Some("your accounting code".to_owned()), start_date :
                Some("your start date".to_owned()), origin : Some("your origin"
                .to_owned()) }
            ],
        )
        .subscriptions(
            vec![
                ...
                Some("your starts at".to_owned()), unit_amount : Some(1.0), auto_renew :
                ...
                }]), plan_id : Some("your plan id".to_owned()), shipping :
                ...
                total_billing_cycles : Some(1), revenue_schedule_type :
                ...
                plan_code : "your plan code".to_owned() }
            ],
        )
