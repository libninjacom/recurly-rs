...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { quantity : Some(1), credit_reason_code :
                Some("your credit reason code".to_owned()), start_date :
                Some("your start date".to_owned()), item_id : Some("your item id"
                .to_owned()), type_ : "your type".to_owned(), description :
                Some("your description".to_owned()), unit_amount : 1.0, currency :
                "your currency".to_owned(), end_date : Some("your end date".to_owned()),
                revenue_schedule_type : Some("your revenue schedule type".to_owned()),
                tax_exempt : Some(true), accounting_code : Some("your accounting code"
                .to_owned()), avalara_service_type : Some(1), avalara_transaction_type :
                Some(1), origin : Some("your origin".to_owned()), item_code :
                Some("your item code".to_owned()), tax_inclusive : Some(true), tax_code :
        ...
        .subscriptions(
            vec![
                ...
                Some("your next bill date".to_owned()), revenue_schedule_type :
                Some("your revenue schedule type".to_owned()), custom_fields :
                Some(CustomFields(vec![CustomField { name : "your name".to_owned(), value
                : "your value".to_owned() }])), shipping :
                ...
                .to_owned()) }), trial_ends_at : Some("your trial ends at".to_owned()),
                renewal_billing_cycles : Some(1), quantity : Some(1), tax_inclusive :
                Some(true), ramp_intervals : Some(vec![SubscriptionRampInterval {
                starting_billing_cycle : Some(1), unit_amount : Some(1) }]), plan_id :
                Some("your plan id".to_owned()), plan_code : "your plan code".to_owned(),
                add_ons : Some(vec![SubscriptionAddOnCreate { unit_amount : Some(1.0),
                unit_amount_decimal : Some("your unit amount decimal".to_owned()), code :
                "your code".to_owned(), revenue_schedule_type :
