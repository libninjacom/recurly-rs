...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { quantity : Some(1), item_code : Some("your item code"
                .to_owned()), item_id : Some("your item id".to_owned()),
                revenue_schedule_type : Some("your revenue schedule type".to_owned()),
                credit_reason_code : Some("your credit reason code".to_owned()), tax_code
                : Some("your tax code".to_owned()), type_ : "your type".to_owned(),
                start_date : Some("your start date".to_owned()), accounting_code :
                Some("your accounting code".to_owned()), end_date : Some("your end date"
                .to_owned()), tax_inclusive : Some(true), unit_amount : 1.0, description
                : Some("your description".to_owned()), avalara_transaction_type :
                Some(1), tax_exempt : Some(true), avalara_service_type : Some(1), origin
                : Some("your origin".to_owned()), currency : "your currency".to_owned(),
                product_code : Some("your product code".to_owned()) }
            ],
        )
        .subscriptions(
            vec![
                SubscriptionPurchase { auto_renew : Some(true), plan_id :
                Some("your plan id".to_owned()), unit_amount : Some(1.0), trial_ends_at :
                Some("your trial ends at".to_owned()), tax_inclusive : Some(true),
                starts_at : Some("your starts at".to_owned()), next_bill_date :
                Some("your next bill date".to_owned()), plan_code : "your plan code"
                .to_owned(), quantity : Some(1), revenue_schedule_type :
                Some("your revenue schedule type".to_owned()), add_ons :
                Some(vec![SubscriptionAddOnCreate { unit_amount : Some(1.0), tiers :
                ...
                "your code".to_owned(), quantity : Some(1), usage_percentage : Some(1.0),
                add_on_source : Some("your add on source".to_owned()) }]), custom_fields
                : Some(CustomFields(vec![CustomField { value : "your value".to_owned(),
                name : "your name".to_owned() }])), shipping :
                ...
                .to_owned()) }), renewal_billing_cycles : Some(1), ramp_intervals :
                Some(vec![SubscriptionRampInterval { unit_amount : Some(1),
                starting_billing_cycle : Some(1) }]), total_billing_cycles : Some(1) }
            ],
        )
