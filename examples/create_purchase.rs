...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { quantity : Some(1), type_ : "your type".to_owned(),
                unit_amount : 1.0, avalara_transaction_type : Some(1), currency :
                "your currency".to_owned(), tax_inclusive : Some(true),
                credit_reason_code : Some("your credit reason code".to_owned()),
                avalara_service_type : Some(1), tax_code : Some("your tax code"
                .to_owned()), start_date : Some("your start date".to_owned()),
                revenue_schedule_type : Some("your revenue schedule type".to_owned()),
                item_id : Some("your item id".to_owned()), accounting_code :
                Some("your accounting code".to_owned()), tax_exempt : Some(true),
                description : Some("your description".to_owned()), item_code :
        ...
        .subscriptions(
            vec![
                SubscriptionPurchase { auto_renew : Some(true), plan_code :
                "your plan code".to_owned(), tax_inclusive : Some(true),
                total_billing_cycles : Some(1), ramp_intervals :
                ...
                : Some(CustomFields(vec![CustomField { name : "your name".to_owned(),
                value : "your value".to_owned() }])), renewal_billing_cycles : Some(1),
                unit_amount : Some(1.0), quantity : Some(1), next_bill_date :
                ...
                .to_owned()), starts_at : Some("your starts at".to_owned()), shipping :
