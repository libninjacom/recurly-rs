...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { item_id : Some("your item id".to_owned()), unit_amount :
                1.0, type_ : "your type".to_owned(), origin : Some("your origin"
                .to_owned()), description : Some("your description".to_owned()),
                product_code : Some("your product code".to_owned()),
                avalara_transaction_type : Some(1), tax_exempt : Some(true), tax_code :
                Some("your tax code".to_owned()), item_code : Some("your item code"
                .to_owned()), revenue_schedule_type : Some("your revenue schedule type"
                .to_owned()), currency : "your currency".to_owned(), start_date :
                Some("your start date".to_owned()), end_date : Some("your end date"
                .to_owned()), tax_inclusive : Some(true), quantity : Some(1),
        ...
        .subscriptions(
            vec![
                SubscriptionPurchase { quantity : Some(1), total_billing_cycles :
                Some(1), auto_renew : Some(true), add_ons :
                Some(vec![SubscriptionAddOnCreate { add_on_source :
                Some("your add on source".to_owned()), percentage_tiers :
                ...
                : Some(1.0), ending_quantity : Some(1) }]), quantity : Some(1),
                revenue_schedule_type : Some("your revenue schedule type".to_owned()),
                unit_amount : Some(1.0), unit_amount_decimal :
                Some("your unit amount decimal".to_owned()), usage_percentage : Some(1.0)
                ...
                : "your value".to_owned(), name : "your name".to_owned() }])), starts_at
                : Some("your starts at".to_owned()), trial_ends_at :
                ...
                .to_owned()) }), plan_code : "your plan code".to_owned(), tax_inclusive :
                Some(true), plan_id : Some("your plan id".to_owned()),
                revenue_schedule_type : Some("your revenue schedule type".to_owned()),
