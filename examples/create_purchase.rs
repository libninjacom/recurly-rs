    ...
    let response = client
        ...
        .line_items(
            vec![
                ...
                unit_amount : 1.0, accounting_code : Some("your accounting code"
                .to_owned()), tax_inclusive : Some(true), quantity : Some(1), tax_exempt
                : Some(true), avalara_transaction_type : Some(1), start_date :
                Some("your start date".to_owned()), revenue_schedule_type :
                ...
                .to_owned()), origin : Some("your origin".to_owned()), end_date :
                Some("your end date".to_owned()) }
            ],
        )
        .subscriptions(
            vec![
                SubscriptionPurchase { tax_inclusive : Some(true), total_billing_cycles :
                Some(1), add_ons : Some(vec![SubscriptionAddOnCreate { tiers :
                ...
                ending_amount : Some(1.0) }]), code : "your code".to_owned(),
                revenue_schedule_type : Some("your revenue schedule type".to_owned()),
                unit_amount : Some(1.0), quantity : Some(1), usage_percentage : Some(1.0)
                }]), starts_at : Some("your starts at".to_owned()), plan_id :
                Some("your plan id".to_owned()), quantity : Some(1),
                ...
                unit_amount : Some(1.0), shipping : Some(SubscriptionShippingPurchase {
                method_id : Some("your method id".to_owned()), method_code :
                Some("your method code".to_owned()), amount : Some(1.0) }), auto_renew :
                Some(true), revenue_schedule_type : Some("your revenue schedule type"
                .to_owned()), next_bill_date : Some("your next bill date".to_owned()),
                trial_ends_at : Some("your trial ends at".to_owned()), custom_fields :
