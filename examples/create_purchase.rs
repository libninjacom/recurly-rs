    ...
    let response = client
        ...
        .line_items(
            vec![
                ...
                .to_owned()), tax_exempt : Some(true), end_date : Some("your end date"
                .to_owned()), quantity : Some(1), avalara_transaction_type : Some(1),
                item_code : Some("your item code".to_owned()), type_ : "your type"
                .to_owned(), credit_reason_code : Some("your credit reason code"
                .to_owned()), avalara_service_type : Some(1), product_code :
                Some("your product code".to_owned()), unit_amount : 1.0, description :
                Some("your description".to_owned()), currency : "your currency"
                .to_owned(), tax_inclusive : Some(true), item_id : Some("your item id"
                .to_owned()), start_date : Some("your start date".to_owned()), origin :
        ...
        .subscriptions(
            vec![
                SubscriptionPurchase { renewal_billing_cycles : Some(1), starts_at :
                Some("your starts at".to_owned()), ramp_intervals :
                Some(vec![SubscriptionRampInterval { starting_billing_cycle : Some(1),
                unit_amount : Some(1) }]), total_billing_cycles : Some(1), auto_renew :
                Some(true), unit_amount : Some(1.0), revenue_schedule_type :
                Some("your revenue schedule type".to_owned()), custom_fields :
                Some(CustomFields(vec![CustomField { value : "your value".to_owned(),
                name : "your name".to_owned() }])), tax_inclusive : Some(true), plan_code
                : "your plan code".to_owned(), quantity : Some(1), plan_id :
                Some("your plan id".to_owned()), add_ons :
                ...
                Some("your add on source".to_owned()) }]), shipping :
