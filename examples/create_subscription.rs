...
async fn main() {
    ...
    let account = AccountCreate {
        ...
        shipping_addresses: vec![
            ShippingAddressCreate { company : Some("your company".to_owned()), email :
            Some("your email".to_owned()), postal_code : "your postal code".to_owned(),
            last_name : "your last name".to_owned(), vat_number : Some("your vat number"
            .to_owned()), city : "your city".to_owned(), street2 : Some("your street 2"
            .to_owned()), country : "your country".to_owned(), first_name :
            "your first name".to_owned(), phone : Some("your phone".to_owned()), street1
            : "your street 1".to_owned(), nickname : Some("your nickname".to_owned()),
            region : Some("your region".to_owned()) }
        ],
    ...
    let response = client
        ...
        .add_ons(
            vec![
                ...
                quantity : Some(1), percentage_tiers :
