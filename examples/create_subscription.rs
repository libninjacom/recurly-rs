...
async fn main() {
    ...
    let account = AccountCreate {
        ...
        shipping_addresses: vec![
            ShippingAddressCreate { email : Some("your email".to_owned()), country :
            "your country".to_owned(), phone : Some("your phone".to_owned()), city :
            "your city".to_owned(), nickname : Some("your nickname".to_owned()), region :
            Some("your region".to_owned()), first_name : "your first name".to_owned(),
            street1 : "your street 1".to_owned(), company : Some("your company"
            .to_owned()), postal_code : "your postal code".to_owned(), vat_number :
    ...
    let response = client
        ...
        .add_ons(
            vec![
                SubscriptionAddOnCreate { add_on_source : Some("your add on source"
