...
async fn main() {
    ...
    let account = AccountCreate {
        ...
        shipping_addresses: vec![
            ShippingAddressCreate { street2 : Some("your street 2".to_owned()), city :
            "your city".to_owned(), region : Some("your region".to_owned()), postal_code
            : "your postal code".to_owned(), country : "your country".to_owned(),
            first_name : "your first name".to_owned(), last_name : "your last name"
            .to_owned(), phone : Some("your phone".to_owned()), nickname :
            Some("your nickname".to_owned()), email : Some("your email".to_owned()),
    ...
    let response = client
        ...
        .add_ons(
            vec![
                SubscriptionAddOnCreate { unit_amount : Some(1.0), percentage_tiers :
                Some(vec![SubscriptionAddOnPercentageTier { ending_amount : Some(1.0),
                usage_percentage : Some("your usage percentage".to_owned()) }]), tiers :
