...
async fn main() {
    ...
    let account = AccountCreate {
        ...
        shipping_addresses: vec![
            ...
            .to_owned(), company : Some("your company".to_owned()), email :
            Some("your email".to_owned()), vat_number : Some("your vat number"
            .to_owned()), street2 : Some("your street 2".to_owned()), postal_code :
            "your postal code".to_owned(), street1 : "your street 1".to_owned(), phone :
            Some("your phone".to_owned()), city : "your city".to_owned(), region :
            Some("your region".to_owned()), country : "your country".to_owned() }
        ],
    };
    ...
    let response = client
        ...
        .add_ons(
            vec![
                SubscriptionAddOnCreate { quantity : Some(1), code : "your code"
                .to_owned(), percentage_tiers : Some(vec![SubscriptionAddOnPercentageTier
                { usage_percentage : Some("your usage percentage".to_owned()),
                ending_amount : Some(1.0) }]), tiers : Some(vec![SubscriptionAddOnTier {
                usage_percentage : Some("your usage percentage".to_owned()),
                unit_amount_decimal : Some("your unit amount decimal".to_owned()),
                unit_amount : Some(1.0), ending_quantity : Some(1) }]), add_on_source :
