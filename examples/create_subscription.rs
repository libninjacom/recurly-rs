...
async fn main() {
    ...
    let account = AccountCreate {
        shipping_addresses: vec![
            ...
            "your city".to_owned(), first_name : "your first name".to_owned(), last_name
            : "your last name".to_owned(), region : Some("your region".to_owned()),
            street2 : Some("your street 2".to_owned()), email : Some("your email"
            .to_owned()), vat_number : Some("your vat number".to_owned()), postal_code :
