...
async fn main() {
    ...
    let account = AccountCreate {
        ...
        shipping_addresses: vec![
            ...
            .to_owned()), vat_number : Some("your vat number".to_owned()), street2 :
            Some("your street 2".to_owned()), region : Some("your region".to_owned()),
            phone : Some("your phone".to_owned()), postal_code : "your postal code"
            .to_owned(), country : "your country".to_owned(), city : "your city"
            .to_owned(), email : Some("your email".to_owned()), first_name :
            "your first name".to_owned(), street1 : "your street 1".to_owned() }
        ],
    };
    ...
    let response = client
        ...
        .add_ons(
            vec![
                ...
                ending_quantity : Some(1), unit_amount : Some(1.0), unit_amount_decimal :
