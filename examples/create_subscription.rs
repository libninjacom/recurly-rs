...
async fn main() {
    ...
    let account = AccountCreate {
        ...
        shipping_addresses: vec![
            ShippingAddressCreate { nickname : Some("your nickname".to_owned()), street2
            : Some("your street 2".to_owned()), phone : Some("your phone".to_owned()),
            company : Some("your company".to_owned()), vat_number :
            Some("your vat number".to_owned()), street1 : "your street 1".to_owned(),
            city : "your city".to_owned(), email : Some("your email".to_owned()),
            last_name : "your last name".to_owned(), region : Some("your region"
            .to_owned()), first_name : "your first name".to_owned(), postal_code :
