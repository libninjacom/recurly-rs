...
async fn main() {
    ...
    let account = AccountCreate {
        ...
        shipping_addresses: vec![
            ShippingAddressCreate { first_name : "your first name".to_owned(), vat_number
            : Some("your vat number".to_owned()), nickname : Some("your nickname"
            .to_owned()), street1 : "your street 1".to_owned(), last_name :
            "your last name".to_owned(), email : Some("your email".to_owned()), phone :
            Some("your phone".to_owned()), country : "your country".to_owned(), city :
    ...
    let response = client
        ...
        .add_ons(
            vec![
                ...
                .to_owned()), ending_quantity : Some(1) }]), add_on_source :
