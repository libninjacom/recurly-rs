...
async fn main() {
    ...
    let account = AccountCreate {
        ...
        shipping_addresses: vec![
            ...
            last_name : "your last name".to_owned(), city : "your city".to_owned(),
            region : Some("your region".to_owned()), first_name : "your first name"
            .to_owned(), street1 : "your street 1".to_owned(), street2 :
            Some("your street 2".to_owned()), postal_code : "your postal code"
            .to_owned(), company : Some("your company".to_owned()), phone :
            Some("your phone".to_owned()), country : "your country".to_owned(), email :
