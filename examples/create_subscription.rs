...
async fn main() {
    ...
    let account = AccountCreate {
        ...
        shipping_addresses: vec![
            ShippingAddressCreate { region : Some("your region".to_owned()), phone :
            Some("your phone".to_owned()), first_name : "your first name".to_owned(),
            company : Some("your company".to_owned()), email : Some("your email"
            ...
            Some("your street 2".to_owned()), country : "your country".to_owned(), city :
            "your city".to_owned(), postal_code : "your postal code".to_owned() }
        ],
    };
    ...
    let response = client
        ...
        .add_ons(
            vec![
                SubscriptionAddOnCreate { quantity : Some(1), percentage_tiers :
                ...
                tiers : Some(vec![SubscriptionAddOnTier { ending_quantity : Some(1),
                usage_percentage : Some("your usage percentage".to_owned()),
                ...
                .to_owned()), code : "your code".to_owned() }
            ],
        )
