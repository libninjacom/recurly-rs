...
async fn main() {
    ...
    let account = AccountCreate {
        ...
        shipping_addresses: vec![
            ShippingAddressCreate { region : Some("your region".to_owned()), company :
            Some("your company".to_owned()), email : Some("your email".to_owned()),
            nickname : Some("your nickname".to_owned()), phone : Some("your phone"
            .to_owned()), street2 : Some("your street 2".to_owned()), street1 :
            "your street 1".to_owned(), country : "your country".to_owned(), vat_number :
            Some("your vat number".to_owned()), city : "your city".to_owned(), first_name
            : "your first name".to_owned(), postal_code : "your postal code".to_owned(),
    ...
    let response = client
        ...
        .add_ons(
            vec![
                SubscriptionAddOnCreate { tiers : Some(vec![SubscriptionAddOnTier {
