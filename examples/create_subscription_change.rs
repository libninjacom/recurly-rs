...
async fn main() {
    ...
    let response = client
        ...
        .add_ons(
            vec![
                SubscriptionAddOnUpdate { code : Some("your code".to_owned()),
                usage_percentage : Some(1.0), quantity : Some(1), add_on_source :
                Some("your add on source".to_owned()), unit_amount : Some(1.0),
                unit_amount_decimal : Some("your unit amount decimal".to_owned()), id :
                Some("your id".to_owned()), tiers : Some(vec![SubscriptionAddOnTier {
