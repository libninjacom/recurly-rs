...
async fn main() {
    ...
    let response = client
        ...
        .add_ons(
            vec![
                SubscriptionAddOnUpdate { tiers : Some(vec![SubscriptionAddOnTier {
                ...
                Some(1.0), code : Some("your code".to_owned()), unit_amount : Some(1.0),
                id : Some("your id".to_owned()), quantity : Some(1), percentage_tiers :
