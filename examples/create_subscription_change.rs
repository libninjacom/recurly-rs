...
async fn main() {
    ...
    let response = client
        ...
        .add_ons(
            vec![
                SubscriptionAddOnUpdate { quantity : Some(1), unit_amount : Some(1.0),
                ...
                : Some(1.0) }]), usage_percentage : Some(1.0), id : Some("your id"
                .to_owned()), add_on_source : Some("your add on source".to_owned()), code
