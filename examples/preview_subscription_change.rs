...
async fn main() {
    ...
    let response = client
        ...
        .add_ons(
            vec![
                SubscriptionAddOnUpdate { id : Some("your id".to_owned()),
                ...
                Some("your code".to_owned()), tiers : Some(vec![SubscriptionAddOnTier {
                ...
                : Some(1.0), ending_quantity : Some(1) }]), usage_percentage : Some(1.0)
                }
            ],
        )
