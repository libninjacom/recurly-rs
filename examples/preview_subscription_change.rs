...
async fn main() {
    ...
    let response = client
        ...
        .add_ons(
            vec![
                SubscriptionAddOnUpdate { usage_percentage : Some(1.0),
                ...
                Some("your id".to_owned()), code : Some("your code".to_owned()), quantity
                : Some(1), add_on_source : Some("your add on source".to_owned()), tiers :
                ...
                Some("your unit amount decimal".to_owned()) }]), unit_amount_decimal :
