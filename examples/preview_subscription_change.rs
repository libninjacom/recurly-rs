...
async fn main() {
    ...
    let response = client
        ...
        .add_ons(
            vec![
                SubscriptionAddOnUpdate { unit_amount : Some(1.0), usage_percentage :
                ...
                id : Some("your id".to_owned()), unit_amount_decimal :
                Some("your unit amount decimal".to_owned()), code : Some("your code"
                .to_owned()) }
            ],
        )
