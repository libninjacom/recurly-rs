...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { type_ : "your type".to_owned(), avalara_service_type :
                Some(1), product_code : Some("your product code".to_owned()),
                tax_inclusive : Some(true), origin : Some("your origin".to_owned()),
                quantity : Some(1), item_code : Some("your item code".to_owned()),
                currency : "your currency".to_owned(), description :
                Some("your description".to_owned()), credit_reason_code :
                Some("your credit reason code".to_owned()), accounting_code :
                Some("your accounting code".to_owned()), tax_exempt : Some(true),
                tax_code : Some("your tax code".to_owned()), start_date :
                Some("your start date".to_owned()), avalara_transaction_type : Some(1),
                end_date : Some("your end date".to_owned()), unit_amount : 1.0, item_id :
                Some("your item id".to_owned()), revenue_schedule_type :
        ...
        .subscriptions(
            vec![
                ...
                trial_ends_at : Some("your trial ends at".to_owned()),
                renewal_billing_cycles : Some(1), revenue_schedule_type :
                Some("your revenue schedule type".to_owned()), shipping :
                ...
                .to_owned()) }), tax_inclusive : Some(true), plan_id :
                Some("your plan id".to_owned()), total_billing_cycles : Some(1),
                auto_renew : Some(true), next_bill_date : Some("your next bill date"
                .to_owned()), custom_fields : Some(CustomFields(vec![CustomField { name :
                "your name".to_owned(), value : "your value".to_owned() }])), unit_amount
                : Some(1.0), quantity : Some(1), starts_at : Some("your starts at"
                .to_owned()), ramp_intervals : Some(vec![SubscriptionRampInterval {
                unit_amount : Some(1), starting_billing_cycle : Some(1) }]), add_ons :
                Some(vec![SubscriptionAddOnCreate { unit_amount : Some(1.0),
                percentage_tiers : Some(vec![SubscriptionAddOnPercentageTier {
                ending_amount : Some(1.0), usage_percentage :
                Some("your usage percentage".to_owned()) }]), tiers :
                ...
                Some(1.0), add_on_source : Some("your add on source".to_owned()) }]) }
            ],
        )
