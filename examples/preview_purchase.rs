...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { currency : "your currency".to_owned(),
                revenue_schedule_type : Some("your revenue schedule type".to_owned()),
                tax_exempt : Some(true), origin : Some("your origin".to_owned()),
                quantity : Some(1), description : Some("your description".to_owned()),
                item_id : Some("your item id".to_owned()), avalara_service_type :
                Some(1), tax_code : Some("your tax code".to_owned()), start_date :
                Some("your start date".to_owned()), tax_inclusive : Some(true), end_date
                : Some("your end date".to_owned()), credit_reason_code :
                Some("your credit reason code".to_owned()), avalara_transaction_type :
                Some(1), product_code : Some("your product code".to_owned()), type_ :
        ...
        .subscriptions(
            vec![
                SubscriptionPurchase { shipping : Some(SubscriptionShippingPurchase {
                amount : Some(1.0), method_code : Some("your method code".to_owned()),
                method_id : Some("your method id".to_owned()) }), quantity : Some(1),
                trial_ends_at : Some("your trial ends at".to_owned()), add_ons :
                Some(vec![SubscriptionAddOnCreate { revenue_schedule_type :
                ...
                name : "your name".to_owned() }])), renewal_billing_cycles : Some(1),
                revenue_schedule_type : Some("your revenue schedule type".to_owned()),
                starts_at : Some("your starts at".to_owned()), auto_renew : Some(true),
                plan_id : Some("your plan id".to_owned()), ramp_intervals :
