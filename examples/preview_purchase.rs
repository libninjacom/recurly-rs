...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { item_id : Some("your item id".to_owned()), description :
                Some("your description".to_owned()), type_ : "your type".to_owned(),
                avalara_transaction_type : Some(1), origin : Some("your origin"
                .to_owned()), currency : "your currency".to_owned(), tax_code :
                Some("your tax code".to_owned()), end_date : Some("your end date"
                .to_owned()), quantity : Some(1), tax_exempt : Some(true), unit_amount :
                1.0, item_code : Some("your item code".to_owned()), accounting_code :
                Some("your accounting code".to_owned()), avalara_service_type : Some(1),
                revenue_schedule_type : Some("your revenue schedule type".to_owned()),
                credit_reason_code : Some("your credit reason code".to_owned()),
                start_date : Some("your start date".to_owned()), product_code :
                Some("your product code".to_owned()), tax_inclusive : Some(true) }
            ],
        )
        .subscriptions(
            vec![
                ...
                renewal_billing_cycles : Some(1), quantity : Some(1), add_ons :
                Some(vec![SubscriptionAddOnCreate { quantity : Some(1), unit_amount :
                ...
                .to_owned(), add_on_source : Some("your add on source".to_owned()), tiers
                ...
                Some("your unit amount decimal".to_owned()) }]) }]), next_bill_date :
                Some("your next bill date".to_owned()), auto_renew : Some(true),
                total_billing_cycles : Some(1), tax_inclusive : Some(true), shipping :
                Some(SubscriptionShippingPurchase { method_id : Some("your method id"
                .to_owned()), method_code : Some("your method code".to_owned()), amount :
                Some(1.0) }), starts_at : Some("your starts at".to_owned()),
                revenue_schedule_type : Some("your revenue schedule type".to_owned()),
                plan_id : Some("your plan id".to_owned()), plan_code : "your plan code"
                .to_owned() }
            ],
        )
