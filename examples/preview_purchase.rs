    ...
    let response = client
        ...
        .line_items(
            vec![
                ...
                Some("your credit reason code".to_owned()), tax_code :
                Some("your tax code".to_owned()), item_code : Some("your item code"
                .to_owned()), origin : Some("your origin".to_owned()),
                avalara_service_type : Some(1), accounting_code :
                ...
                .to_owned()), tax_exempt : Some(true), quantity : Some(1), description :
                Some("your description".to_owned()), product_code :
                Some("your product code".to_owned()), start_date : Some("your start date"
                .to_owned()), currency : "your currency".to_owned(), type_ : "your type"
                .to_owned(), avalara_transaction_type : Some(1), unit_amount : 1.0,
                item_id : Some("your item id".to_owned()) }
            ],
        )
        .subscriptions(
            vec![
                SubscriptionPurchase { plan_id : Some("your plan id".to_owned()),
                custom_fields : Some(CustomFields(vec![CustomField { value : "your value"
                .to_owned(), name : "your name".to_owned() }])), renewal_billing_cycles :
                Some(1), starts_at : Some("your starts at".to_owned()), tax_inclusive :
                ...
                "your plan code".to_owned(), quantity : Some(1), revenue_schedule_type :
                Some("your revenue schedule type".to_owned()), shipping :
                Some(SubscriptionShippingPurchase { amount : Some(1.0), method_id :
                Some("your method id".to_owned()), method_code : Some("your method code"
                .to_owned()) }), unit_amount : Some(1.0), add_ons :
                Some(vec![SubscriptionAddOnCreate { usage_percentage : Some(1.0),
                ...
                Some("your usage percentage".to_owned()) }]), revenue_schedule_type :
                Some("your revenue schedule type".to_owned()), add_on_source :
                Some("your add on source".to_owned()), quantity : Some(1), code :
                "your code".to_owned(), unit_amount : Some(1.0), tiers :
                Some(vec![SubscriptionAddOnTier { unit_amount : Some(1.0),
                unit_amount_decimal : Some("your unit amount decimal".to_owned()),
                usage_percentage : Some("your usage percentage".to_owned()),
                ending_quantity : Some(1) }]) }]), total_billing_cycles : Some(1),
                next_bill_date : Some("your next bill date".to_owned()), auto_renew :
                Some(true) }
            ],
        )
