...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { avalara_service_type : Some(1), description :
                Some("your description".to_owned()), accounting_code :
                Some("your accounting code".to_owned()), tax_exempt : Some(true),
                unit_amount : 1.0, quantity : Some(1), end_date : Some("your end date"
                .to_owned()), avalara_transaction_type : Some(1), item_code :
                Some("your item code".to_owned()), tax_code : Some("your tax code"
                .to_owned()), currency : "your currency".to_owned(), credit_reason_code :
                Some("your credit reason code".to_owned()), product_code :
                Some("your product code".to_owned()), start_date : Some("your start date"
                .to_owned()), type_ : "your type".to_owned(), origin : Some("your origin"
                .to_owned()), revenue_schedule_type : Some("your revenue schedule type"
                .to_owned()), item_id : Some("your item id".to_owned()), tax_inclusive :
                Some(true) }
            ],
        )
        .subscriptions(
            vec![
                ...
                Some(1), starting_billing_cycle : Some(1) }]), tax_inclusive :
                Some(true), next_bill_date : Some("your next bill date".to_owned()),
                add_ons : Some(vec![SubscriptionAddOnCreate { add_on_source :
                Some("your add on source".to_owned()), usage_percentage : Some(1.0),
                ...
                Some("your revenue schedule type".to_owned()), quantity : Some(1), tiers
                ...
                code : "your code".to_owned() }]), custom_fields :
                Some(CustomFields(vec![CustomField { name : "your name".to_owned(), value
                : "your value".to_owned() }])), trial_ends_at : Some("your trial ends at"
                .to_owned()), renewal_billing_cycles : Some(1), shipping :
                ...
                quantity : Some(1), plan_code : "your plan code".to_owned(), unit_amount
                : Some(1.0), total_billing_cycles : Some(1), auto_renew : Some(true) }
            ],
        )
