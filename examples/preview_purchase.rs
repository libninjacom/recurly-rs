    ...
    let response = client
        ...
        .line_items(
            vec![
                ...
                avalara_service_type : Some(1), avalara_transaction_type : Some(1),
                start_date : Some("your start date".to_owned()), end_date :
                Some("your end date".to_owned()), item_code : Some("your item code"
                .to_owned()), tax_code : Some("your tax code".to_owned()),
                revenue_schedule_type : Some("your revenue schedule type".to_owned()),
                origin : Some("your origin".to_owned()), tax_exempt : Some(true),
                unit_amount : 1.0, type_ : "your type".to_owned(), item_id :
                Some("your item id".to_owned()), currency : "your currency".to_owned(),
                description : Some("your description".to_owned()), credit_reason_code :
                Some("your credit reason code".to_owned()), tax_inclusive : Some(true),
                quantity : Some(1) }
            ],
        )
        .subscriptions(
            vec![
                ...
                .to_owned()) }), renewal_billing_cycles : Some(1), plan_id :
                Some("your plan id".to_owned()), auto_renew : Some(true), plan_code :
                "your plan code".to_owned(), revenue_schedule_type :
                ...
                usage_percentage : Some(1.0), code : "your code".to_owned(),
                ...
                ending_quantity : Some(1) }]), percentage_tiers :
                Some(vec![SubscriptionAddOnPercentageTier { ending_amount : Some(1.0),
                usage_percentage : Some("your usage percentage".to_owned()) }]),
                revenue_schedule_type : Some("your revenue schedule type".to_owned()),
                quantity : Some(1) }]), unit_amount : Some(1.0), tax_inclusive :
                Some(true) }
            ],
        )
