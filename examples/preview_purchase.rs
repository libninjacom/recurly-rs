...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { tax_exempt : Some(true), unit_amount : 1.0, start_date :
                ...
                Some("your item id".to_owned()), type_ : "your type".to_owned(),
                description : Some("your description".to_owned()), revenue_schedule_type
                : Some("your revenue schedule type".to_owned()), currency :
                "your currency".to_owned(), end_date : Some("your end date".to_owned()),
                avalara_service_type : Some(1), quantity : Some(1), credit_reason_code :
                Some("your credit reason code".to_owned()), item_code :
                Some("your item code".to_owned()), avalara_transaction_type : Some(1) }
            ],
        )
        .subscriptions(
            vec![
                SubscriptionPurchase { total_billing_cycles : Some(1), quantity :
                Some(1), renewal_billing_cycles : Some(1), auto_renew : Some(true),
                plan_code : "your plan code".to_owned(), custom_fields :
                ...
                usage_percentage : Some(1.0), code : "your code".to_owned(), unit_amount
