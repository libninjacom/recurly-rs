    ...
    let response = client
        ...
        .line_items(
            vec![
                ...
                Some("your accounting code".to_owned()), tax_inclusive : Some(true),
                type_ : "your type".to_owned(), tax_exempt : Some(true),
                avalara_transaction_type : Some(1), end_date : Some("your end date"
                .to_owned()), avalara_service_type : Some(1), start_date :
                Some("your start date".to_owned()), item_id : Some("your item id"
                .to_owned()), credit_reason_code : Some("your credit reason code"
                .to_owned()), tax_code : Some("your tax code".to_owned()), product_code :
                Some("your product code".to_owned()), origin : Some("your origin"
                .to_owned()), currency : "your currency".to_owned(), unit_amount : 1.0,
                item_code : Some("your item code".to_owned()), quantity : Some(1),
        ...
        .subscriptions(
            vec![
                ...
                Some(1), unit_amount : Some(1.0), plan_code : "your plan code"
                ...
                usage_percentage : Some(1.0), tiers : Some(vec![SubscriptionAddOnTier {
                ...
                quantity : Some(1), unit_amount_decimal : Some("your unit amount decimal"
                ...
                revenue_schedule_type : Some("your revenue schedule type".to_owned()),
                code : "your code".to_owned(), add_on_source : Some("your add on source"
                .to_owned()), unit_amount : Some(1.0) }]), starts_at :
                Some("your starts at".to_owned()), renewal_billing_cycles : Some(1),
