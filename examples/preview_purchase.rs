...
async fn main() {
    ...
    let response = client
        ...
        .line_items(
            vec![
                LineItemCreate { credit_reason_code : Some("your credit reason code"
                .to_owned()), unit_amount : 1.0, tax_code : Some("your tax code"
                .to_owned()), avalara_transaction_type : Some(1), product_code :
                Some("your product code".to_owned()), avalara_service_type : Some(1),
                tax_inclusive : Some(true), description : Some("your description"
                .to_owned()), quantity : Some(1), type_ : "your type".to_owned(),
                tax_exempt : Some(true), accounting_code : Some("your accounting code"
                .to_owned()), start_date : Some("your start date".to_owned()), item_id :
                Some("your item id".to_owned()), origin : Some("your origin".to_owned()),
                end_date : Some("your end date".to_owned()), revenue_schedule_type :
                Some("your revenue schedule type".to_owned()), item_code :
        ...
        .subscriptions(
            vec![
                ...
                plan_code : "your plan code".to_owned(), starts_at :
                Some("your starts at".to_owned()), unit_amount : Some(1.0), tax_inclusive
                : Some(true), total_billing_cycles : Some(1), revenue_schedule_type :
                ...
                Some(1.0), code : "your code".to_owned(), tiers :
                ...
                Some(1.0) }), quantity : Some(1), auto_renew : Some(true), ramp_intervals
                : Some(vec![SubscriptionRampInterval { starting_billing_cycle : Some(1),
                unit_amount : Some(1) }]), plan_id : Some("your plan id".to_owned()),
