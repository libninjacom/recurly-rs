    ...
    let response = client
        ...
        .line_items(
            vec![
                ...
                .to_owned()), type_ : "your type".to_owned(), accounting_code :
                Some("your accounting code".to_owned()), end_date : Some("your end date"
                .to_owned()), description : Some("your description".to_owned()),
                start_date : Some("your start date".to_owned()), currency :
                "your currency".to_owned(), unit_amount : 1.0, avalara_service_type :
                Some(1), origin : Some("your origin".to_owned()), quantity : Some(1),
                item_code : Some("your item code".to_owned()), tax_code :
                Some("your tax code".to_owned()), product_code : Some("your product code"
                .to_owned()), item_id : Some("your item id".to_owned()),
                avalara_transaction_type : Some(1), revenue_schedule_type :
                Some("your revenue schedule type".to_owned()), tax_inclusive :
                Some(true), tax_exempt : Some(true) }
            ],
        )
        .subscriptions(
            vec![
                ...
                renewal_billing_cycles : Some(1), unit_amount : Some(1.0),
                total_billing_cycles : Some(1), trial_ends_at : Some("your trial ends at"
                .to_owned()), revenue_schedule_type : Some("your revenue schedule type"
                .to_owned()), plan_code : "your plan code".to_owned(), plan_id :
                ...
                .to_owned()) }]), usage_percentage : Some(1.0), code : "your code"
                ...
                unit_amount : Some(1.0), quantity : Some(1), percentage_tiers :
                ...
                .to_owned(), value : "your value".to_owned() }])), shipping :
