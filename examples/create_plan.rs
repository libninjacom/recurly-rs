...
async fn main() {
    ...
    let currencies = vec![
        ...
        Some(1.0), tax_inclusive : Some(true), setup_fee : Some(1.0) }
    ];
    let response = client
        ...
        .add_ons(
            vec![
                AddOnCreate { default_quantity : Some(1), accounting_code :
                Some("your accounting code".to_owned()), optional : Some(true),
                avalara_transaction_type : Some(1), avalara_service_type : Some(1),
                add_on_type : Some("your add on type".to_owned()), item_id :
                Some("your item id".to_owned()), tax_code : Some("your tax code"
                .to_owned()), measured_unit_name : Some("your measured unit name"
                .to_owned()), item_code : Some("your item code".to_owned()), currencies :
                ...
                plan_id : Some("your plan id".to_owned()), tier_type :
                Some("your tier type".to_owned()), tiers : Some(vec![Tier {
                ...
                usage_percentage : Some(1.0), display_quantity : Some(true), code :
                "your code".to_owned(), name : "your name".to_owned(), percentage_tiers :
