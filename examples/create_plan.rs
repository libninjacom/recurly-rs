...
async fn main() {
    ...
    let response = client
        ...
        .add_ons(
            vec![
                AddOnCreate { code : "your code".to_owned(), item_code :
                Some("your item code".to_owned()), display_quantity : Some(true),
                add_on_type : Some("your add on type".to_owned()), measured_unit_id :
                Some("your measured unit id".to_owned()), plan_id : Some("your plan id"
                .to_owned()), default_quantity : Some(1), optional : Some(true),
                ...
                tax_inclusive : Some(true) }]), usage_type : Some("your usage type"
                .to_owned()), usage_timeframe : Some("your usage timeframe".to_owned()),
                usage_percentage : Some(1.0), tier_type : Some("your tier type"
                ...
                unit_amount_decimal : Some("your unit amount decimal".to_owned()),
                unit_amount : Some(1.0) }]), ending_quantity : Some(1) }]),
                measured_unit_name : Some("your measured unit name".to_owned()),
                accounting_code : Some("your accounting code".to_owned()), item_id :
                ...
                Some("your currency".to_owned()) }]), avalara_transaction_type : Some(1),
