...
async fn main() {
    ...
    let response = client
        ...
        .add_ons(
            vec![
                AddOnCreate { item_code : Some("your item code".to_owned()), currencies :
                Some(vec![AddOnPricing { currency : "your currency".to_owned(),
                unit_amount_decimal : Some("your unit amount decimal".to_owned()),
                unit_amount : Some(1.0), tax_inclusive : Some(true) }]), tier_type :
                Some("your tier type".to_owned()), display_quantity : Some(true), name :
                "your name".to_owned(), avalara_service_type : Some(1), usage_type :
                Some("your usage type".to_owned()), plan_id : Some("your plan id"
                .to_owned()), default_quantity : Some(1), usage_timeframe :
                Some("your usage timeframe".to_owned()), usage_calculation_type :
                Some("your usage calculation type".to_owned()), optional : Some(true),
                ...
                code : "your code".to_owned(), add_on_type : Some("your add on type"
                .to_owned()), avalara_transaction_type : Some(1), tax_code :
                Some("your tax code".to_owned()), revenue_schedule_type :
                Some("your revenue schedule type".to_owned()), tiers : Some(vec![Tier {
