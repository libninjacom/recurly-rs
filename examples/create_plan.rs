...
async fn main() {
    ...
    let response = client
        ...
        .add_ons(
            vec![
                AddOnCreate { name : "your name".to_owned(), plan_id :
                Some("your plan id".to_owned()), tax_code : Some("your tax code"
                ...
                avalara_service_type : Some(1), currencies : Some(vec![AddOnPricing {
                tax_inclusive : Some(true), unit_amount : Some(1.0), unit_amount_decimal
                : Some("your unit amount decimal".to_owned()), currency : "your currency"
                .to_owned() }]), tiers : Some(vec![Tier { usage_percentage :
                Some("your usage percentage".to_owned()), ending_quantity : Some(1),
                currencies : Some(vec![TierPricing { unit_amount_decimal :
                ...
                .to_owned()) }]), avalara_transaction_type : Some(1), measured_unit_id :
                Some("your measured unit id".to_owned()), usage_percentage : Some(1.0),
                usage_type : Some("your usage type".to_owned()), usage_calculation_type :
                ...
                display_quantity : Some(true), item_id : Some("your item id".to_owned()),
                add_on_type : Some("your add on type".to_owned()), optional : Some(true),
                tier_type : Some("your tier type".to_owned()) }
            ],
        )
