...
async fn main() {
    ...
    let response = client
        ...
        .add_ons(
            vec![
                AddOnCreate { measured_unit_id : Some("your measured unit id"
                .to_owned()), usage_calculation_type : Some("your usage calculation type"
                .to_owned()), code : "your code".to_owned(), default_quantity : Some(1),
                avalara_service_type : Some(1), tier_type : Some("your tier type"
                ...
                Some("your accounting code".to_owned()), display_quantity : Some(true),
