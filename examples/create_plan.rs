    ...
    let response = client
        ...
        .add_ons(
            vec![
                ...
                tier_type : Some("your tier type".to_owned()), name : "your name"
                .to_owned(), item_id : Some("your item id".to_owned()),
                usage_calculation_type : Some("your usage calculation type".to_owned()),
                usage_percentage : Some(1.0), display_quantity : Some(true), tax_code :
                ...
                }]), add_on_type : Some("your add on type".to_owned()), optional :
                Some(true), tiers : Some(vec![Tier { ending_quantity : Some(1),
                ...
                .to_owned()), usage_type : Some("your usage type".to_owned()), currencies
                : Some(vec![AddOnPricing { unit_amount : Some(1.0), unit_amount_decimal :
                Some("your unit amount decimal".to_owned()), tax_inclusive : Some(true),
                currency : "your currency".to_owned() }]), usage_timeframe :
                Some("your usage timeframe".to_owned()), measured_unit_id :
                Some("your measured unit id".to_owned()), code : "your code".to_owned(),
                avalara_transaction_type : Some(1), item_code : Some("your item code"
                .to_owned()), avalara_service_type : Some(1), default_quantity : Some(1)
                }
            ],
        )
