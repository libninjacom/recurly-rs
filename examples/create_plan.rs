...
async fn main() {
    ...
    let response = client
        ...
        .add_ons(
            vec![
                AddOnCreate { plan_id : Some("your plan id".to_owned()),
                usage_calculation_type : Some("your usage calculation type".to_owned()),
                tax_code : Some("your tax code".to_owned()), tiers : Some(vec![Tier {
                ...
                unit_amount : Some(1.0) }]) }]), usage_percentage : Some(1.0), code :
                "your code".to_owned(), default_quantity : Some(1), revenue_schedule_type
                : Some("your revenue schedule type".to_owned()), display_quantity :
                Some(true), optional : Some(true), usage_timeframe :
                Some("your usage timeframe".to_owned()), measured_unit_id :
                Some("your measured unit id".to_owned()), measured_unit_name :
                Some("your measured unit name".to_owned()), currencies :
                ...
                }]), avalara_transaction_type : Some(1), item_code :
                Some("your item code".to_owned()), avalara_service_type : Some(1),
                ...
                currency : Some("your currency".to_owned()) }]), name : "your name"
                .to_owned(), usage_type : Some("your usage type".to_owned()), item_id :
