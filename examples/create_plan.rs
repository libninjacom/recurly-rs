...
async fn main() {
    ...
    let response = client
        ...
        .add_ons(
            vec![
                AddOnCreate { default_quantity : Some(1), avalara_service_type : Some(1),
                plan_id : Some("your plan id".to_owned()), tiers : Some(vec![Tier {
                ...
                tax_code : Some("your tax code".to_owned()), percentage_tiers :
                ...
                }]), usage_percentage : Some(1.0), name : "your name".to_owned(),
                ...
                tier_type : Some("your tier type".to_owned()), add_on_type :
                Some("your add on type".to_owned()), measured_unit_name :
                Some("your measured unit name".to_owned()), usage_timeframe :
                Some("your usage timeframe".to_owned()), accounting_code :
                Some("your accounting code".to_owned()), item_id : Some("your item id"
                .to_owned()), usage_calculation_type : Some("your usage calculation type"
                .to_owned()), optional : Some(true), item_code : Some("your item code"
                .to_owned()), measured_unit_id : Some("your measured unit id"
                .to_owned()), display_quantity : Some(true) }
            ],
        )
