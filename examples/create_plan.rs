...
async fn main() {
    ...
    let response = client
        ...
        .add_ons(
            vec![
                AddOnCreate { tier_type : Some("your tier type".to_owned()), currencies :
                Some(vec![AddOnPricing { unit_amount_decimal :
                Some("your unit amount decimal".to_owned()), unit_amount : Some(1.0),
                currency : "your currency".to_owned(), tax_inclusive : Some(true) }]),
                code : "your code".to_owned(), measured_unit_name :
                Some("your measured unit name".to_owned()), percentage_tiers :
                ...
                }]) }]), avalara_transaction_type : Some(1), tax_code :
                Some("your tax code".to_owned()), usage_timeframe :
                Some("your usage timeframe".to_owned()), avalara_service_type : Some(1),
                ...
                Some("your unit amount decimal".to_owned()) }]) }]), usage_type :
                Some("your usage type".to_owned()), revenue_schedule_type :
                Some("your revenue schedule type".to_owned()), add_on_type :
                Some("your add on type".to_owned()), usage_calculation_type :
                Some("your usage calculation type".to_owned()), usage_percentage :
                Some(1.0), accounting_code : Some("your accounting code".to_owned()),
                measured_unit_id : Some("your measured unit id".to_owned()), plan_id :
                Some("your plan id".to_owned()), item_code : Some("your item code"
                .to_owned()), item_id : Some("your item id".to_owned()), optional :
                Some(true), default_quantity : Some(1), name : "your name".to_owned(),
                display_quantity : Some(true) }
            ],
        )
