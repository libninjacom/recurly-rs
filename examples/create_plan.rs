    ...
    let response = client
        ...
        .add_ons(
            vec![
                ...
                currency : Some("your currency".to_owned()) }]), tier_type :
                ...
                Some("your item code".to_owned()), default_quantity : Some(1),
                usage_timeframe : Some("your usage timeframe".to_owned()),
                avalara_transaction_type : Some(1), usage_type : Some("your usage type"
                ...
                Some(1.0), avalara_service_type : Some(1), item_id : Some("your item id"
                .to_owned()), plan_id : Some("your plan id".to_owned()),
                usage_calculation_type : Some("your usage calculation type".to_owned()),
                accounting_code : Some("your accounting code".to_owned()), code :
                "your code".to_owned(), display_quantity : Some(true), name : "your name"
