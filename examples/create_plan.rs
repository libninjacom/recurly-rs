...
async fn main() {
    ...
    let response = client
        ...
        .add_ons(
            vec![
                AddOnCreate { plan_id : Some("your plan id".to_owned()), tax_code :
                Some("your tax code".to_owned()), usage_calculation_type :
                Some("your usage calculation type".to_owned()), default_quantity :
                Some(1), item_code : Some("your item code".to_owned()), percentage_tiers
                ...
                Some(true), item_id : Some("your item id".to_owned()), measured_unit_id :
                ...
                .to_owned() }]), usage_timeframe : Some("your usage timeframe"
                ...
                .to_owned(), usage_percentage : Some(1.0), optional : Some(true),
                accounting_code : Some("your accounting code".to_owned()), tier_type :
                Some("your tier type".to_owned()), add_on_type : Some("your add on type"
