    ...
    let response = client
        ...
        .add_ons(
            vec![
                ...
                Some("your currency".to_owned()) }]), measured_unit_name :
                Some("your measured unit name".to_owned()), tier_type :
                Some("your tier type".to_owned()), item_code : Some("your item code"
                .to_owned()), revenue_schedule_type : Some("your revenue schedule type"
                .to_owned()), default_quantity : Some(1), plan_id : Some("your plan id"
                ...
                Some("your unit amount decimal".to_owned()), currency : "your currency"
                .to_owned() }]) }]), code : "your code".to_owned(), item_id :
                Some("your item id".to_owned()), avalara_transaction_type : Some(1),
                usage_percentage : Some(1.0), name : "your name".to_owned(),
                measured_unit_id : Some("your measured unit id".to_owned()), add_on_type
                : Some("your add on type".to_owned()), accounting_code :
                Some("your accounting code".to_owned()), usage_type :
