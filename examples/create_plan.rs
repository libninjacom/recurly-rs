...
async fn main() {
    ...
    let response = client
        ...
        .add_ons(
            vec![
                AddOnCreate { add_on_type : Some("your add on type".to_owned()),
                item_code : Some("your item code".to_owned()), usage_percentage :
                Some(1.0), plan_id : Some("your plan id".to_owned()), display_quantity :
                Some(true), name : "your name".to_owned(), accounting_code :
                Some("your accounting code".to_owned()), default_quantity : Some(1),
                tier_type : Some("your tier type".to_owned()), usage_type :
                Some("your usage type".to_owned()), optional : Some(true),
                ...
                code : "your code".to_owned(), avalara_transaction_type : Some(1),
                ...
                Some("your currency".to_owned()) }]), tiers : Some(vec![Tier { currencies
