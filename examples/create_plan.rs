...
async fn main() {
    ...
    let response = client
        ...
        .add_ons(
            vec![
                AddOnCreate { item_id : Some("your item id".to_owned()), tax_code :
                Some("your tax code".to_owned()), currencies : Some(vec![AddOnPricing {
                tax_inclusive : Some(true), unit_amount : Some(1.0), currency :
                ...
                tiers : Some(vec![Tier { currencies : Some(vec![TierPricing { unit_amount
                ...
                default_quantity : Some(1), avalara_service_type : Some(1), add_on_type :
                Some("your add on type".to_owned()), measured_unit_id :
                Some("your measured unit id".to_owned()), avalara_transaction_type :
                ...
                display_quantity : Some(true), item_code : Some("your item code"
                .to_owned()), revenue_schedule_type : Some("your revenue schedule type"
                .to_owned()), optional : Some(true), measured_unit_name :
                Some("your measured unit name".to_owned()), code : "your code"
                .to_owned(), name : "your name".to_owned(), plan_id : Some("your plan id"
                .to_owned()) }
            ],
        )
