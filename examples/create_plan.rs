    ...
    let response = client
        ...
        .add_ons(
            vec![
                ...
                Some("your unit amount decimal".to_owned()) }]) }]), plan_id :
                Some("your plan id".to_owned()), percentage_tiers :
                ...
                .to_owned()) }]), avalara_service_type : Some(1), code : "your code"
                .to_owned(), add_on_type : Some("your add on type".to_owned()), item_code
                : Some("your item code".to_owned()), measured_unit_id :
                Some("your measured unit id".to_owned()), revenue_schedule_type :
