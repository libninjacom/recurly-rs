...
async fn main() {
    ...
    let response = client
        ...
        .add_ons(
            vec![
                AddOnCreate { avalara_transaction_type : Some(1), tiers : Some(vec![Tier
                ...
                Some("your usage type".to_owned()), optional : Some(true), tier_type :
                Some("your tier type".to_owned()), usage_timeframe :
                Some("your usage timeframe".to_owned()), plan_id : Some("your plan id"
                .to_owned()), name : "your name".to_owned(), display_quantity :
                Some(true), revenue_schedule_type : Some("your revenue schedule type"
                .to_owned()), item_id : Some("your item id".to_owned()), percentage_tiers
