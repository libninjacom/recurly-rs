...
async fn main() {
    ...
    let name = "your name";
    let currencies = vec![
        PlanPricing { setup_fee : Some(1.0), unit_amount : Some(1.0), tax_inclusive :
    ...
    let response = client
        ...
        .add_ons(
            vec![
                AddOnCreate { name : "your name".to_owned(), usage_type :
                Some("your usage type".to_owned()), avalara_transaction_type : Some(1),
                ...
                currency : Some("your currency".to_owned()) }]), default_quantity :
                Some(1), measured_unit_name : Some("your measured unit name".to_owned()),
                usage_percentage : Some(1.0), item_code : Some("your item code"
                ...
                tier_type : Some("your tier type".to_owned()), usage_timeframe :
                Some("your usage timeframe".to_owned()), avalara_service_type : Some(1),
                measured_unit_id : Some("your measured unit id".to_owned()), code :
                "your code".to_owned(), add_on_type : Some("your add on type"
                .to_owned()), display_quantity : Some(true), item_id :
                Some("your item id".to_owned()), plan_id : Some("your plan id"
                .to_owned()), revenue_schedule_type : Some("your revenue schedule type"
                .to_owned()), optional : Some(true), tax_code : Some("your tax code"
