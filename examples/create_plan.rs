...
async fn main() {
    ...
    let name = "your name";
    let currencies = vec![
        PlanPricing { tax_inclusive : Some(true), unit_amount : Some(1.0), setup_fee :
    ...
    let response = client
        ...
        .add_ons(
            vec![
                ...
                Some("your unit amount decimal".to_owned()) }]) }]), name : "your name"
                ...
                Some("your usage percentage".to_owned()) }]) }]), measured_unit_id :
                Some("your measured unit id".to_owned()), tier_type :
                Some("your tier type".to_owned()), display_quantity : Some(true),
                tax_code : Some("your tax code".to_owned()), optional : Some(true),
                add_on_type : Some("your add on type".to_owned()), plan_id :
                Some("your plan id".to_owned()), measured_unit_name :
                Some("your measured unit name".to_owned()), accounting_code :
                Some("your accounting code".to_owned()), revenue_schedule_type :
                Some("your revenue schedule type".to_owned()), default_quantity :
                Some(1), usage_percentage : Some(1.0), item_code : Some("your item code"
                .to_owned()) }
            ],
        )
