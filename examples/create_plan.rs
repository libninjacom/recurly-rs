...
async fn main() {
    ...
    let response = client
        ...
        .add_ons(
            vec![
                AddOnCreate { usage_timeframe : Some("your usage timeframe".to_owned()),
                usage_type : Some("your usage type".to_owned()), usage_calculation_type :
                Some("your usage calculation type".to_owned()), name : "your name"
                ...
                .to_owned()), default_quantity : Some(1), code : "your code".to_owned(),
                plan_id : Some("your plan id".to_owned()), usage_percentage : Some(1.0),
                optional : Some(true), tax_code : Some("your tax code".to_owned()),
                tier_type : Some("your tier type".to_owned()), tiers : Some(vec![Tier {
                ...
                .to_owned(), unit_amount : Some(1.0) }]) }]), avalara_transaction_type :
                Some(1), add_on_type : Some("your add on type".to_owned()),
                display_quantity : Some(true), percentage_tiers :
                ...
                currencies : Some(vec![AddOnPricing { unit_amount_decimal :
