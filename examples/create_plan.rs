...
async fn main() {
    ...
    let currencies = vec![
        ...
        Some(true), setup_fee : Some(1.0), unit_amount : Some(1.0) }
    ];
    let response = client
        ...
        .add_ons(
            vec![
                ...
                add_on_type : Some("your add on type".to_owned()), accounting_code :
                ...
                .to_owned()) }]), default_quantity : Some(1), plan_id :
                Some("your plan id".to_owned()), usage_type : Some("your usage type"
                ...
                Some(1), usage_timeframe : Some("your usage timeframe".to_owned()), name
                : "your name".to_owned(), usage_percentage : Some(1.0), tax_code :
