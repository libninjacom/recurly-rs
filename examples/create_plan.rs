    ...
    let response = client
        ...
        .add_ons(
            vec![
                ...
                currency : Some("your currency".to_owned()) }]), measured_unit_id :
                ...
                Some("your usage timeframe".to_owned()), item_code :
                Some("your item code".to_owned()), usage_type : Some("your usage type"
                .to_owned()) }
            ],
        )
