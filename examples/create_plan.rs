    ...
    let response = client
        ...
        .add_ons(
            vec![
                ...
                item_code : Some("your item code".to_owned()), accounting_code :
                ...
                optional : Some(true), item_id : Some("your item id".to_owned()),
                usage_type : Some("your usage type".to_owned()), plan_id :
                Some("your plan id".to_owned()), usage_percentage : Some(1.0),
                measured_unit_id : Some("your measured unit id".to_owned()),
                default_quantity : Some(1), display_quantity : Some(true), tax_code :
                ...
                }]) }]), avalara_transaction_type : Some(1), tier_type :
