...
async fn main() {
    ...
    let response = client
        ...
        .add_ons(
            vec![
                AddOnCreate { avalara_service_type : Some(1), add_on_type :
                Some("your add on type".to_owned()), usage_type : Some("your usage type"
                .to_owned()), measured_unit_name : Some("your measured unit name"
                .to_owned()), measured_unit_id : Some("your measured unit id"
                .to_owned()), item_code : Some("your item code".to_owned()), code :
                "your code".to_owned(), revenue_schedule_type :
                Some("your revenue schedule type".to_owned()), default_quantity :
                Some(1), avalara_transaction_type : Some(1), tax_code :
                ...
                Some("your unit amount decimal".to_owned()) }]) }]), optional :
                ...
                }]), name : "your name".to_owned(), accounting_code :
                Some("your accounting code".to_owned()), usage_calculation_type :
                Some("your usage calculation type".to_owned()), plan_id :
                Some("your plan id".to_owned()), item_id : Some("your item id"
                .to_owned()), currencies : Some(vec![AddOnPricing { unit_amount :
                Some(1.0), currency : "your currency".to_owned(), unit_amount_decimal :
                Some("your unit amount decimal".to_owned()), tax_inclusive : Some(true)
                }]), usage_percentage : Some(1.0), display_quantity : Some(true) }
            ],
        )
