...
async fn main() {
    ...
    let name = "your name";
    let currencies = vec![
        PlanPricing { tax_inclusive : Some(true), currency : Some("your currency"
        .to_owned()), unit_amount : Some(1.0), setup_fee : Some(1.0) }
    ];
    let response = client
        ...
        .add_ons(
            vec![
                AddOnCreate { item_code : Some("your item code".to_owned()), usage_type :
                Some("your usage type".to_owned()), usage_calculation_type :
                Some("your usage calculation type".to_owned()), accounting_code :
                ...
                Some(vec![PercentageTier { usage_percentage :
                Some("your usage percentage".to_owned()), ending_amount : Some(1.0) }]),
                currency : Some("your currency".to_owned()) }]), add_on_type :
                Some("your add on type".to_owned()), tax_code : Some("your tax code"
                .to_owned()), usage_percentage : Some(1.0), revenue_schedule_type :
                Some("your revenue schedule type".to_owned()), item_id :
                Some("your item id".to_owned()), name : "your name".to_owned(),
                usage_timeframe : Some("your usage timeframe".to_owned()), tiers :
                ...
                Some("your usage percentage".to_owned()) }]), avalara_transaction_type :
                Some(1), display_quantity : Some(true), avalara_service_type : Some(1),
                tier_type : Some("your tier type".to_owned()), measured_unit_id :
                Some("your measured unit id".to_owned()), default_quantity : Some(1),
                code : "your code".to_owned(), measured_unit_name :
                Some("your measured unit name".to_owned()), plan_id : Some("your plan id"
                .to_owned()), optional : Some(true) }
            ],
        )
