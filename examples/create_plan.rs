...
async fn main() {
    ...
    let name = "your name";
    let currencies = vec![
        PlanPricing { unit_amount : Some(1.0), setup_fee : Some(1.0), currency :
    ...
    let response = client
        ...
        .add_ons(
            vec![
                AddOnCreate { measured_unit_name : Some("your measured unit name"
                .to_owned()), display_quantity : Some(true), usage_timeframe :
                Some("your usage timeframe".to_owned()), tiers : Some(vec![Tier {
                ...
                unit_amount : Some(1.0) }]) }]), item_id : Some("your item id"
                .to_owned()), item_code : Some("your item code".to_owned()), tier_type :
                Some("your tier type".to_owned()), usage_calculation_type :
                Some("your usage calculation type".to_owned()), currencies :
                Some(vec![AddOnPricing { currency : "your currency".to_owned(),
                unit_amount_decimal : Some("your unit amount decimal".to_owned()),
                tax_inclusive : Some(true), unit_amount : Some(1.0) }]), usage_type :
                Some("your usage type".to_owned()), percentage_tiers :
                ...
                }]), tax_code : Some("your tax code".to_owned()), name : "your name"
                .to_owned(), usage_percentage : Some(1.0), default_quantity : Some(1),
                measured_unit_id : Some("your measured unit id".to_owned()), plan_id :
                Some("your plan id".to_owned()), optional : Some(true), code :
