...
async fn main() {
    ...
    let response = client
        ...
        .add_ons(
            vec![
                AddOnCreate { item_id : Some("your item id".to_owned()), usage_type :
                Some("your usage type".to_owned()), name : "your name".to_owned(),
                plan_id : Some("your plan id".to_owned()), revenue_schedule_type :
                Some("your revenue schedule type".to_owned()), avalara_service_type :
                Some(1), tiers : Some(vec![Tier { usage_percentage :
                ...
                tax_code : Some("your tax code".to_owned()), item_code :
                Some("your item code".to_owned()), code : "your code".to_owned(),
                optional : Some(true), usage_percentage : Some(1.0),
                ...
                Some("your add on type".to_owned()), avalara_transaction_type : Some(1),
                currencies : Some(vec![AddOnPricing { tax_inclusive : Some(true),
                unit_amount : Some(1.0), unit_amount_decimal :
                Some("your unit amount decimal".to_owned()), currency : "your currency"
                .to_owned() }]), display_quantity : Some(true), default_quantity :
